...
def _test_engine() -> GameEngine:
    rules = {
        ...
        'effectors': {
            ...
            'do_remove_expr': {'ops': [
                {'op': 'remove', 'array': {'template': 'hand_{$pid}'},
                 'value': {'var': '$target'}},
            ]},
            'do_remove_env': {'ops': [
            ...
            'do_set_array': {'ops': [
                {'op': 'setArray', 'array': 'melds',
                 'value': {'map': {'list': {'var': '$list'},
                                   'expr': {'const': {'type': 'peng'}}}}},
            ]},
            'do_set_env_list': {'ops': [
                {'op': 'setArray', 'array': 'claim_queue',
                 'value': {'const': ['x', 'y']}},
            ]},
            'do_append_expr': {'ops': [
                {'op': 'append', 'array': {'template': 'hand_{$pid}'},
                 'value': {'var': '$tile'}},
            ]},
            'do_append_expr_value': {'ops': [
                {'op': 'append', 'array': 'melds', 'value': {'sum': {'var': '$list'}}},
            ]},
            'do_append_value_dict': {'ops': [
                {'op': 'append', 'array': 'melds',
                 'value': {'type': 'chi', 'count': {'var': '$n'}}},
            ]},
        },
        'actions': [],
        'phases': [],
